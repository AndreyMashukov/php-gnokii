...
use \Logics\BuildTools\CodeSniffer\Reporting;
 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/tests/Core/ReportingTest.php $
 *
...
class ReportingTest extends PHPUnit_Framework_TestCase
	...
	public function testFactory()
	    {
		define("EXCEPTION_REPORT_TYPE_NOT_FOUND", 1);

		$type        = "checkstyle";
		$reportClass = $this->reporting->factory($type);
		$this->assertInstanceOf("\\Logics\\BuildTools\\CodeSniffer\\Report", $reportClass);
		$this->assertInstanceOf("\\Logics\\BuildTools\\CodeSniffer\\CheckstyleReport", $reportClass);

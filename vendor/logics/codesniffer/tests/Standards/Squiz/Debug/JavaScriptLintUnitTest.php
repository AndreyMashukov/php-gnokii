 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/tests/Standards/Squiz/Debug/JavaScriptLintUnitTest.php $
 *
 * @donottranslate
 */
...
class JavaScriptLintUnitTest extends AbstractSniffUnitTest
	...
	protected function expectations()
	    {
		return array("JavaScriptLintUnitTest.inc.testfile" => array("warnings" => array(2 => 1)));
	    } //end expectations()

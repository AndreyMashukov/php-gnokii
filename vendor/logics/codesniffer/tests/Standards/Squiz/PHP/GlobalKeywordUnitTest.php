 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/tests/Standards/Squiz/PHP/GlobalKeywordUnitTest.php $
 */
...
class GlobalKeywordUnitTest extends AbstractSniffUnitTest
	...
	protected function expectations()
	    {
		return array(
			"GlobalKeywordUnitTest.inc.testfile" => array(
								 "errors" => array(
									      8 => 1,
									      9 => 1,
									     ),

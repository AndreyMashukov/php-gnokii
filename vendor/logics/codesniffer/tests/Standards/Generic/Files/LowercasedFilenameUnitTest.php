 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/tests/Standards/Generic/Files/LowercasedFilenameUnitTest.php $
 */
...
class LowercasedFilenameUnitTest extends AbstractSniffUnitTest
	...
	protected function expectations()
	    {
		return array(
			"LowercasedFilenameUnitTest.inc.testfile" => array(
								      "errors" => array(1 => 1),
								     ),
		       );
	    } //end expectations()

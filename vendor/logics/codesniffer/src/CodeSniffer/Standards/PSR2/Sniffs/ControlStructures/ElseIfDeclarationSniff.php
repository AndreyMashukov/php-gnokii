 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/src/CodeSniffer/Standards/PSR2/Sniffs/ControlStructures/ElseIfDeclarationSniff.php $
 */
...
class ElseIfDeclarationSniff implements Sniff
	...
	public function process(File $phpcsFile, $stackPtr)
		...
		if ($tokens[$next]["code"] === T_IF)
		    {
			$error = _("Usage of ELSE IF is discouraged; use ELSEIF instead");

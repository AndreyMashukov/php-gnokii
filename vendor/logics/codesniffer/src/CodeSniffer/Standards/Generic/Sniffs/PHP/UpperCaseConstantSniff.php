 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/src/CodeSniffer/Standards/Generic/Sniffs/PHP/UpperCaseConstantSniff.php $
 */
	...
	public function process(File $phpcsFile, $stackPtr)
		...
		if ($tokens[$prevPtr]["code"] !== T_OBJECT_OPERATOR &&
			...
			if (strtoupper($keyword) !== $keyword)
			    {
				$error = _("TRUE, FALSE and NULL must be uppercase; expected") . " \"%s\" " . _("but found") . " \"%s\"";
				$data  = array(
					  strtoupper($keyword),
					  $keyword,
					 );

 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/src/CodeSniffer/Standards/Generic/Sniffs/Files/EndFileNoNewlineSniff.php $
 *
 * @untranslatable PHP
 * @untranslatable JS
 * @untranslatable CSS
...
class EndFileNoNewlineSniff implements Sniff
	...
	public function process(File $phpcsFile, $stackPtr)
		...
		if ($lastChars === $phpcsFile->eolChar)
		    {
			$error = _("File must not end with a newline character");

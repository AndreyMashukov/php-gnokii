...
/**
 * The base class for all CodeSniffer documentation generators.
 *
 * PHP version 5.6
 *
 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/src/CodeSniffer/DocGenerators/DocGenerator.php $
 */
...
class DocGenerator
	...
	/**
	 * Constructs a DocGenerator object.
	 *
	...
	protected function getStandardFiles()
		...
		if (is_dir($this->_standard) === true)
		    ...
		    {
			$standardDir = realpath(__DIR__ . "/../Standards/" . $this->_standard);
		...
		foreach ($sniffs as $sniff)
			...
			if (empty($this->_sniffs) === true || in_array($sniffName, $this->_sniffs) === true)
			    {

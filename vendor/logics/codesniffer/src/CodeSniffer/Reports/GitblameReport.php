...
/**
 * Gitblame report for CodeSniffer.
 *
 * PHP version 5.6
 *
 ...
 * @link      $HeadURL: https://open.logics.net.au/buildtools/codesniffer/tags/0.1.3/src/CodeSniffer/Reports/GitblameReport.php $
 *
 * @untranslatable GIT
 */

class GitblameReport extends VersionControlReports
    {
	 ...
	 *
	 * @untranslatable .git
	 * @untranslatable git blame --date=short \"
	 * @untranslatable r
	 */
	...
	protected function getBlameContent($filename)
		...
		Console::report(_("Getting GIT blame info for") . " " . basename($filename) . "... ", 0, 0, "");
		...
		if ($found === true)
		    ...
		    {
			echo _("ERROR: Could not locate .git directory") . " " . PHP_EOL . PHP_EOL;
			exit(2);
		    }
